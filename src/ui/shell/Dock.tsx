...
const DOCK_DESC: Record<SupportedLocale, Record<Exclude<ShellPage, "daily">, string>> = {
  ...
  ja: {
    ...
    explore:
      "語料を振り返る：夜話 Q&A、AITI イメージ、学習サマリー、円卓ディスカッション。",
    network: "会話がプロジェクトとトピックでつながるグラフ。時間とともに育ちます。",
    prompts: "保存済みセッションをスキャンし、よく使うプロンプトを発見してライブラリ化。",
    deposits:
      "夢が毎日のセッションを長期記憶に蒸留し、ナレッジは蒸留ドキュメントとして保管されます。",
    settings: "モデル、キャプチャ、メンバーシップ、ペアリング、外観などの設定。",
  },
  ko: {
    home: "캡처량, 활동 추세, 소스 분포를 한눈에 보는 대시보드.",
    library: "데스크톱과 브라우저 확장에서 캡처한 모든 대화를 소스·프로젝트·주제별로 탐색·관리.",
    explore: "코퍼스 성찰: 밤의 대화 Q&A, AITI 이미지, 학습 종합, 원탁 토론.",
    network: "대화가 프로젝트와 주제로 연결된 그래프. 시간이 지날수록 자랍니다.",
    prompts: "보관된 세션을 스캔해 자주 쓰는 프롬프트를 찾아 라이브러리에 정리.",
    deposits: "꿈이 매일의 세션을 장기 기억으로 정제하고, 지식 문서는 정제된 지식을 보관합니다.",
