export const koTranslations = {
  ...
  dashboard: {
    ...
    library: {
      ...
      navSourcesTip: "소스별 단계 탐색: 브라우저 / 각 에이전트 플랫폼 → 프로젝트 → 주제. 사용자 폴더는 브라우저 노드 아래에 있습니다.",
      navNotesTip: "로컬 Markdown 노트. Obsidian으로 보낼 수 있습니다.",
      organizeTip: "로컬 규칙만으로 일괄 정리: 빈 대화 삭제·중복 병합·일괄 태그·주제 보관. 데이터는 기기를 떠나지 않습니다.",
    ...
    explore: {
      ...
      toolExplanations: {
        ...
        answer_synthesizer: "모은 근거로부터 최종 답변을 생성하고, 결과를 확인할 수 있는 위치를 사용자에게 알려 줍니다."
      },
      intentLabels: {
        fact_lookup: "사실 조회",
    ...
    prompts: {
      ...
      scanPrivacy: "이 기기에 보관된 본인의 입력만 스캔합니다. LLM 미설정 시 완전히 오프라인으로 동작하며, 설정 시에는 후보 제목을 지을 때 한 번만 모델을 호출합니다.",
    ...
    aiti: {
      ...
      modeAiti: "AITI",
      modeRoundtable: "원탁",
      modeAskTip: "리스너/크리에이터 부엉이와 나누는 밤의 대화. 당신의 세션과 장기 기억을 바탕으로 답합니다.",
      modeAitiTip: "로컬로 계산한 사고의 이미지: 강점·관심 축·장기 투자.",
      modeRoundtableTip: "다섯 부엉이(회의론·낙관·실용·전문·반박)가 하나의 질문을 각자의 입장에서 토론.",
      title: "당신의 AITI — 사고의 강점",
      subtitle: "당신의 대화에서 로컬로 계산됩니다. 판정이 아니라 강점의 반영입니다.",
      insufficient: "이미지가 아직 형성되지 않았습니다 — 신호가 될 대화 요약이 최소 5개 필요합니다. 아래에서 요약을 생성하거나 AI와 계속 대화하면 나타납니다.",
    ...
    learn: {
      ...
      insufficient: "아직 대화가 충분하지 않습니다 — 캡처된 대화가 3개 이상이면 이곳에 학습 지도가 채워지기 시작합니다. 먼저 「밤의 대화」 탭에서 몇 가지 질문을 해 보세요.",
      sample: "분석된 대화 {n}개에서",
      domainsTitle: "지식 도메인",
      uncategorized: "미분류",
